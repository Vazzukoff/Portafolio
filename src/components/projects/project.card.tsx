...
export default function ProjectCard({ project }: ProjectCardProps) {
  return (
    <div className="
      ...
      border border-white/30 hover:border-emerald-400/60 
      rounded-2xl 
      p-5 sm:p-6 md:p-8 
    ...
    ">
      <div className="flex flex-col flex-1">
        ...
        <div className="h-px bg-gradient-to-r from-emerald-400/40 via-white/20 to-transparent mb-4 sm:mb-6"></div>
        
        <p className="
          text-white/80 font-body leading-relaxed 
            ...
            return (
              <div
                ...
                className="
                  ...
                  transition-colors duration-300 
                  group/tech flex-shrink-0 cursor-default
                "
                title={tech}
              >
                <IconComponent 
                ...
                />
                <span className="text-[10px] sm:text-xs font-medium text-white/70 group-hover/tech:text-white/90 transition-colors duration-300 whitespace-nowrap">
                  {tech}
                </span>
              </div>
            );
        ...
        <div className="flex flex-wrap items-center gap-4 sm:gap-8 mt-auto">
          <a
          ...
          >
            ...
            <FaCode className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0" />
          </a>
            ...
            {project.deployUrl && (
              <a
                ...
                rel="noopener noreferrer"
              >
                <span>{project.isProduction ? "Ver sitio" : "Ver demo"}</span>
                <svg
                  className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
